...
global Phi nAtoms time Mass0 Mass1 Pty0in Pty1in Pty2in Mass2
...
hold on
subplot(3, 2, 1), plot(x(Pty2in), y(Pty2in), 'bo', 'markers',...
...
subplot(3,2,3), plot(x(Pty0in), y(Pty0in), 'bo', 'markers',...
    MarkerSize,'MarkerFaceColor','b');
hold on
subplot(3,2,3), plot(x(Pty2in), y(Pty2in), 'bo', 'markers',...
    MarkerSize,'MarkerFaceColor','r');
hold on
...
subplot(3, 2, 5), plot(x(Pty2in), y(Pty2in), 'bo', 'markers',...
    MarkerSize, 'MarkerFaceColor', 'r');
hold on
